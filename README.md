...
| `validation_pilot` | Fixed 10 v1.1.0 validation shards | Reactive IDM agents | IDM + LatentDriver | Run the planners on v1.1.0 regular validation shards; identify interactive scenarios post-rollout via metadata. | Next |
